...
### Methods
- **Checkout** : Your customers can select to get debited from pocket account or make a transfer to a bank account . [continue reading](/accept-payments/checkout)
...
## 2 - Virtual wallets
Create a wallet using our wallets API and use the virtual account number generated for the wallet to accept payments. [continue reading](/accept-payments/wallets/wallet-overview)
