...
Upon creating a customer, a default wallet is automatically generated for them.
![login](/images/customer-detail.png)

Additional wallets can be created later if needed. 
![login](/images/customer-wallet.png)

You have two options: either create individual customers, each with a unique wallet or create a single customer with multiple wallets.
![login](/images/view-customers.png)
