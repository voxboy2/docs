...
---
Enhance your business operations using our Scheduled Payments API which enables you to set up recurring transfers for your business needs such as payroll, vendor payments, ride settlements, and so much more. 
...
​
## Cancel/Re-Activate Payment
You can cancel a payment or re-activate recurring payments by calling this endpoint. 
...
NOTE: If a payment has an end_date and the end date has passed, You will not be able to reactivate.
